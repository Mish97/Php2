...
<section class="header1 cid-rFhIRIVy07 mbr-fullscreen" id="header1-u">
    <div class="container">
        <h1 class="mbr-section-title mbr-fonts-style align-right mbr-bold mbr-white display-1">
            <strong>Everyone you need for your Web Project on one place...</strong></h1>
        <h3 class="mbr-section-subtitle mbr-fonts-style align-right mbr-white mbr-light display-2">Find Web designers and developers in Websy</h3>
        
        <div class="mbr-section-btn align-right"><a class="btn btn-md btn-info display-4" href="index.html#gallery1-f">Services<br></a></div>
    </div>

</section>

<section class="footer1 cid-rEYcz3SyJW" id="footer1-4">
<div class="container">
